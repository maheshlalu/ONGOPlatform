...
@interface CXAlbumVideoCollectionViewController ()
...
@implementation CXAlbumVideoCollectionViewController
...
- (void)viewDidLoad
{
    ...
    self.staticTextField.text = @"No videos available";
...
-(void)populateVideoList
{
    ...
    for(int index = 0; index < self.videoList.count; ++index)
    {
        CGSize size;
...
{
    static NSString *CellIdentifier = @"AlbumVideoCell";
    ...
    if(productIndex < self.videoList.count)
    {
        NSString* imageUrl = self.videoList[productIndex];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    pageViewController.leftNavigationItemName = @"VIDEOS";
    ...
    for(int index = 0; index < self.videoList.count; ++index)
    {
        ...
        viewController.urlString = self.videoList[index];
    }
